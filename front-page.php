...
<section class="yr-hero" data-hero>
	<?php foreach ( $hero_slides as $i => $slide ) : ?>
		<?php
		$slide_subtitle = $slide['subtitle'] ?: sprintf( __( 'Welcome to %s', 'your-restaurant' ), $settings['site_name'] );
		?>
		<?php if ( 0 === $i ) : ?>
			<div class="yr-hero__slide is-active" data-hero-slide data-hero-subtitle="<?php echo esc_attr( $slide_subtitle ); ?>">
				<img
		...
		<?php else : ?>
			<div class="yr-hero__slide" data-hero-slide data-hero-src="<?php echo esc_url( $slide['image'] ); ?>" data-hero-subtitle="<?php echo esc_attr( $slide_subtitle ); ?>"></div>
		<?php endif; ?>
	<?php endforeach; ?>
	<div class="yr-hero__overlay" aria-hidden="true"></div>
	<div class="yr-hero__vignette" aria-hidden="true"></div>
	...
	<div class="yr-hero__content">
		<p class="yr-hero__eyebrow yr-reveal" data-hero-eyebrow><?php echo esc_html( $hero_slides[0]['subtitle'] ?: sprintf( __( 'Welcome to %s', 'your-restaurant' ), $settings['site_name'] ) ); ?></p>
		<h1 class="yr-hero__title yr-reveal yr-reveal--delay-1">
		...
		<p class="yr-hero__subtitle yr-reveal yr-reveal--delay-2"><?php echo esc_html( $settings['hero_subtitle'] ); ?></p>
		<div class="yr-hero__actions yr-reveal yr-reveal--delay-3">
	...
	<div class="yr-container yr-stats__grid">
		<?php foreach ( $settings['stats'] as $i => $stat ) : ?>
			<div class="yr-stat yr-reveal">
				<span class="yr-stat__ornament" aria-hidden="true"></span>
...
<section class="yr-section yr-section--story">
...
<section class="yr-cta-band">
	<div class="yr-cta-band__texture" aria-hidden="true"></div>
...
<?php if ( $testimonials ) : ?>
<section class="yr-section yr-section--testimonials">
	<div class="yr-container">
		<div class="yr-section__header yr-section__header--center yr-reveal">
