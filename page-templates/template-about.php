...
<section class="yr-section" data-reveal>
	<div class="yr-container yr-grid-2">
		...
		<div class="yr-about-image" style="position:relative;">
			<img src="<?php echo esc_url( yr_placeholder( 'about' ) ); ?>" alt="<?php esc_attr_e( 'Dining room', 'your-restaurant' ); ?>" width="700" height="820" style="width:100%;height:520px;object-fit:cover;" loading="lazy" decoding="async" />
